...
export default function CryptoTestamentLab() {
  ...
  const handleStartRecovery = () => {
    ...
    addLog(`  Cooldown: ${testament.cooldownHours}h (simulado como instantâneo para demo)`);

    // Simula cooldown instantâneo para demo
    attempt.cooldownEndsAt = Date.now();
    setRecoveryAttempt(attempt);
    setSelectedShards([]);
  };
            ...
            <div className="border border-[#14181c] bg-[#0a0d10] p-5">
              ...
              <div className="space-y-3">
                ...
                <div className="p-3 bg-black border border-[#14181c] font-mono text-[10px] text-zinc-500">
                  <div className="mb-1 text-zinc-400">Biometria capturada (simulada):</div>
