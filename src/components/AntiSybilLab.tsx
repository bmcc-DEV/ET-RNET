...
export default function AntiSybilLab() {
  ...
  const handleStartSpamSim = () => {
    ...
    setLegitShards(0);
    setSpamShards(0);
    addLog("=== INICIANDO SIMULAÇÃO DE ATAQUE SYBIL ===");
    ...
    const interval = setInterval(async () => {
      ...
      for (let b = 0; b < 200; b++) {
        ...
        const res = validator.validateShard(botId, commitment, fakePow, fakeVdf);
        ...
        <div className="grid lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-5 space-y-5">
            ...
            <div className="border border-[#14181c] bg-[#0a0d10] p-4">
              ...
              <div className="space-y-2">
                ...
                >
                  {simRunning ? "SIMULAÇÃO EM ANDAMENTO..." : "SIMULAR ATAQUE SYBIL (10K BOTS)"}
                </button>
                <button
                  onClick={handleReset}
          ...
          <div className="lg:col-span-7 space-y-5">
            ...
            {(legitShards > 0 || spamShards > 0) && (
              <div className="border border-[#14181c] bg-black p-4">
                <div className="tag mb-3">RESULTADO DA SIMULAÇÃO SYBIL</div>
