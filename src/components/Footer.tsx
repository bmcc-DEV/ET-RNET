  ...
  return (
    <footer className="bg-black border-t border-[#14181c]">
      <div className="mx-auto max-w-7xl px-6 py-12">
        ...
        <div className="pt-8 border-t border-[#14181c] flex flex-wrap items-center justify-between gap-4 font-mono text-[10px] tracking-[0.25em] text-zinc-600">
          <div>© ∅ — NO ENTITY · NO COPYRIGHT · NO PERMISSION REQUIRED</div>
