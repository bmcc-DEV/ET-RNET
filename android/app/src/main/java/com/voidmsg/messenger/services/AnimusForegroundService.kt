...
class AnimusForegroundService : Service() {
    ...
    private fun startForegroundService() {
        ...
        // TODO: Initialize BLE advertising
        // TODO: Start Nostr heartbeat loop (kind 31219 every 30s)
        // TODO: Subscribe to Nostr task kinds (31222, 31228)

        println("[AnimusService] VØID Animus started — protecting your network")
    }
