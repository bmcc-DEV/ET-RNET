    ...
    <div className="grid md:grid-cols-12 gap-px bg-[#14181c] border border-[#14181c]">
      ...
      <div className="col-span-4 bg-black p-8 border-r border-[#14181c]">
        ...
        <form onSubmit={handlePlaceOrder} className="space-y-6">
          ...
          <button 
            type="submit"
            className={`w-full py-4 font-sans font-bold text-xs tracking-widest transition-smooth ${side === "BUY" ? "bg-[#b6ff3a] text-black hover:bg-white" : "bg-red-500 text-white hover:bg-red-400"}`}
          >
